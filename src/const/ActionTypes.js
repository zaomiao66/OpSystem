...
export const SEARCH_TEACHER_NAME_RIGHT = "SEARCH_TEACHER_NAME_RIGHT";//在右边框中搜索老师的名字
export const SELECT_TEACHERS_RIGHT = "SELECT_TEACHERS_RIGHT";//选中右边的老师

export const SELECT_TEACHERS_LEFT = "SELECT_TEACHERS_LEFT";//选中左边的老师

export const OPEN_RIGHTS_MANAGEMENT = "OPEN_RIGHTS_MANAGEMENT";//打开权限页面
export const CLOSE_RIGHTS_MANAGEMENT = "CLOSE_RIGHTS_MANAGEMENT";//关闭权限页面
